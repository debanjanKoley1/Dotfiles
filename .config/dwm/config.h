...
static const char col_gray1[]       = "#210434";       // background color
static const char col_gray2[]       = "#FFFFFF";       // inactive window border color
static const char col_gray3[]       = "#FFFFFF";       // font color
static const char col_gray4[]       = "#210434";       // current tag and current window font color
static const char col_cyan[]        = "#06dbd0";       // top bar second color and active window border color
